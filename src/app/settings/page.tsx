    ...
    <div className="min-h-screen bg-fundo flex flex-col">
      <header className="bg-verde-escuro text-white p-4 md:px-8 flex items-center justify-between gap-3 shadow-md border-b-2 border-dourado/40">
        <div className="flex items-center gap-3">
          <Link href="/painel-pedidos" className="p-2 bg-white/10 rounded-xl hover:bg-white/20 transition-colors ring-1 ring-dourado/30">
            <ArrowLeft size={19} />
          </Link>
          <div>
            <p className="text-[10px] uppercase tracking-[0.22em] font-bold text-dourado">Lumière</p>
            <h1 className="text-base sm:text-xl font-bold flex items-center gap-2">
              <Settings size={19} className="text-dourado" /> Configurações
            </h1>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-4 md:p-8">
        <form onSubmit={salvar} className="space-y-6">
          ...
          <section className="bg-white p-6 rounded-2xl border border-cinza-borda/70 shadow-sm">
            <h2 className="font-bold text-verde-escuro text-lg mb-1.5">Operação do estabelecimento</h2>
          ...
          <section className="bg-white p-6 rounded-2xl border border-cinza-borda/70 shadow-sm">
            ...
            <input
              ...
              className="w-full md:w-1/2 px-4 py-2.5 rounded-xl border border-cinza-borda text-sm focus:outline-none focus:border-verde-normal focus:ring-2 focus:ring-verde-normal/15 text-verde-escuro font-medium transition-all"
              required
            />
          </section>

          <div className="flex items-center justify-end gap-4">
            {salvo && <span className="text-xs font-bold text-dourado-escuro">✓ Configurações salvas.</span>}
            <button
              type="submit"
